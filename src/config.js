const config = {
    ...
    users: {
        ownerId: '273291504494313472', // The bot owner ID, which is you.
        developers: ['273291504494313472', 'Another account ID'] // The bot developers, remember to include your account ID with the other account IDs.
    },
